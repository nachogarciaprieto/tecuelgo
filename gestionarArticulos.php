...
if (!isset($_GET["ID_codigoCategoria"])){
	...
	echo "<table>
			...
			<th>ID_codigoArticulo</th><th>AUTOR</th><th>TITULO</th><th>DESCRIPCIÓN</th><th>PRECIO</th><th>ACTIVO</th><th  style= 'background-color: green;'>EDITAR</th>";
			...
			while($fila=$resultado->fetch()){
				...
				echo "<td><a href='gestionarArticulo.php?ID_codigoArticulo=" . $fila[0] . "'><img src='img/editar.png'></a></td>";
