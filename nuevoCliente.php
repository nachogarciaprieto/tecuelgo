...
<section>
	...
	<br>
	<br>
	<h1><span style="font-size: 30pt;">AÑADIR NUEVO CLIENTE</h1>
	<br>
	...
	-->
	<form  action="nuevoUsuario.php" method="get" enctype="text/plain">

	<fieldset>	    	
	<legend><b>DATOS DEL CLIENTE</b></legend>
	<br>
	ID_email: <input type="text" name="ID_email" required />
	<br>
	<br>
	...
	Tipo de Usuario: <input type="text" name="tipoUsuario" value="2" readonly />	
	</div>
	...
	<br>
	<a href="gestionarUsuarios.php"><input type="button" value="Volver"></a>
	<br>
	<br>
