...
<section class="secciones-editables">
		...
		<br>
		<br>
		<h1><span style="font-size: 30pt;">EDITAR ARTÍCULO</h1>
		<br>
		...
		<form  action="modificarArticulo.php" method="get" enctype="text/plain">
	    ...
	    <br>
	    <a href="editarArticulos.php?ID_codigoCategoria=<?php echo $ID_codigoCategoria; ?>"><input type="button" value="Cancelar"></a>
	    <br>
	    <br> 	    
