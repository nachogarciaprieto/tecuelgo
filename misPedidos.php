...
<section class="secciones-editables">
	...
	<table>
		...
		<th>CÓDIGO DE TU PEDIDO</th><th>FECHA DEL PEDIDO</th><th>ESTADO DE TU PEDIDO</th><th>VER PEDIDO</th>";
		...
		while($fila=$resultado->fetch()){
			...
			echo "<td><button><a href='miPedido.php?ID_codigoPedido=" . $fila[0] . "'><img src='img/editar.png'></a></button></td>";
