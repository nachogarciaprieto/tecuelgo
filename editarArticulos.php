...
if (!isset($_GET["ID_codigoCategoria"])){
	...
	echo "<h2>Estás viendo los Artículos<br>de la Categoría: <b><div style='color:green;'>" . $fila[0] . "</div></b></h2><br>";
	echo "<br><div class='div-categoria'>";
	...
	echo "<table>
			...
			<th>ID_codigoArticulo</th><th>AUTOR</th><th>TITULO</th><th>DESCRIPCIÓN</th><th>PRECIO</th><th>ACTIVO</th><th>EDITAR</th><th>BORRAR</th> ";
			...
			while($fila=$resultado->fetch()){
				...
				echo "<td><button><a href='editarArticulo.php?ID_codigoArticulo=" . $fila[0] . "'><img src='img/editar.png'></a></button></td>";
